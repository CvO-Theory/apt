 ...
 */
public class ArcThatConnectsMatcher extends TypeSafeDiagnosingMatcher<Flow> {

	private final Matcher<? super Node> sourceMatcher;
	private final Matcher<? super Node> targetMatcher;

	private ArcThatConnectsMatcher(Matcher<? super Node> sourceMatcher,
	...
	@Override
	public boolean matchesSafely(Flow arc, Description description) {
