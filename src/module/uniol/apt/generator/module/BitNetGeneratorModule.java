...
/**
 * Module for generating bit nets.
 * @author Uli Schlachter, vsp
 */
@AptModule
public class BitNetGeneratorModule extends AbstractModule implements Module {
	...
	public void run(ModuleInput input, ModuleOutput output) throws ModuleException {
		...
		PetriNet pn = new SimpleBitNetGenerator().generateNet(n);
