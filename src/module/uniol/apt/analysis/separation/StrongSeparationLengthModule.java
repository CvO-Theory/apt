...
/**
 * Provide strong separation for all firable sequences up to a max length as a module.
 *
 * @author Daniel
 */
@AptModule
public class StrongSeparationLengthModule extends AbstractInterruptibleModule implements InterruptibleModule {
	...
	public String getTitle() {
		return "Strong separation with respect to k (length)";
	}

	@Override
	public String getShortDescription() {
		return "Check if all sequences up to a length are strongly k-separable";
	}
	...
	public void run(ModuleInput input, ModuleOutput output) throws ModuleException {
		...
		Separation separation = new Separation(pn, true, k, maxLength, verbose);
