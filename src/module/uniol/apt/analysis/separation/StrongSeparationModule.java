...
/**
 * Provide strong separation check for a given sequence as a module.
 *
 * @author Daniel
 */
@AptModule
public class StrongSeparationModule extends AbstractModule implements InterruptibleModule {
	...
	public String getTitle() {
		return "Strong separation with respect to k (sequence)";
	}

	@Override
	public String getShortDescription() {
		return "Check if a given sequence is strongly k-separable";
	}
