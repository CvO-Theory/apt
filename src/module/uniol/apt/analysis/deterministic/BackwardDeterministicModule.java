 ...
 */
@AptModule
public class BackwardDeterministicModule extends AbstractInterruptibleModule implements InterruptibleModule {

	@Override
	public String getName() {
		return "backwards_deterministic";
	}
	...
	public void provide(ModuleOutputSpec outputSpec) {
		outputSpec.addReturnValue("backwards_deterministic", Boolean.class, "backwards_deterministic",
	...
	public void run(ModuleInput input, ModuleOutput output) throws ModuleException {
		...
		output.setReturnValue("backwards_deterministic", Boolean.class, deterministic.isDeterministic());
	...
	public String getShortDescription() {
		return "Check if a LTS is backwards deterministic";
	}
