 ...
 */
@AptModule
public class PureModule extends AbstractInterruptibleModule implements InterruptibleModule {
	...
	public void provide(ModuleOutputSpec outputSpec) {
		outputSpec.addReturnValue("pure", Boolean.class, "pure", ModuleOutputSpec.PROPERTY_SUCCESS);
	}
