 ...
 */
@AptModule
public class PlainModule extends AbstractInterruptibleModule implements InterruptibleModule {
	...
	public void provide(ModuleOutputSpec outputSpec) {
		outputSpec.addReturnValue("plain", Boolean.class, "plain", ModuleOutputSpec.PROPERTY_SUCCESS);
	}
