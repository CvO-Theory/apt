 ...
 */
@AptModule
public class LoLAPNRendererModule extends AbstractModule implements Module {
	...
	public void provide(ModuleOutputSpec outputSpec) {
		outputSpec.addReturnValue("lola", String.class,
	...
	public String getShortDescription() {
		return "Convert a Petri net to the LoLA format";
	}
