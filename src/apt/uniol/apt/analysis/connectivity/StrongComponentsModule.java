 ...
 */
@AptModule
public class StrongComponentsModule extends AbstractModule implements Module {
	...
	public void run(ModuleInput input, ModuleOutput output) throws ModuleException {
		...
		Components components = Connectivity.getStronglyConnectedComponents(graph);
		output.setReturnValue("strong_components", Components.class, components);
	}
