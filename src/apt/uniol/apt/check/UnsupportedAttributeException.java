...
/**
 * Is thrown from check when an unsupported attribute should be checked
 *
 * @author Daniel
 *
 */
public class UnsupportedAttributeException extends PreconditionFailedException {
	 ...
	 */
	UnsupportedAttributeException(String attribut) {
		super("Attribute \"" + attribut + "\" is not supported.");
	}
}
