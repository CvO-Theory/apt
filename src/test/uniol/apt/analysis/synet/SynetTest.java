...
/**
 * Tests if a labeled transition system is synthesizable by Synet.
 * @author Sören
 *
 */
public class SynetTest {
	...
	public void test() throws Exception {
		try {
			...
			assertTrue(synet.check());
		} catch (SynetNotFoundException e) {
			throw new SkipException("synet not found");
		}
	}
}
