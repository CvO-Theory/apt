...
/**
 * Annotation processor which scans for an AptReturnValueTransformation annotation, analyzes all classes marked by this
...
public class ReturnValueTransformationProcessor extends AbstractSPIServiceProcessor {
	...
	public ReturnValueTransformationProcessor() {
		super(AptReturnValueTransformation.class, ReturnValueTransformation.class, true);
	}
}
