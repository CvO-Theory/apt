...
import uniol.apt.io.parser.impl.synet.SynetPNFormatLexer;
import uniol.apt.io.parser.impl.synet.SynetPNFormatParser;
...
public class SynetPNParser extends AbstractPNParser implements PNParser {
	...
	public PetriNet parsePN(InputStream input) throws ParseException {
		ParserContext<PetriNet> ctx = new APTParserContext<>(
				SynetPNFormatLexer.class, SynetPNFormatParser.class,
