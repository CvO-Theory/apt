...
/**
 * Parses a file in apt format to a petri net.
 * <p/>
 * @author Manuel Gieseking
 */
public class APTPNParser {

	private APTPNParser() {
	}

	/**
	 * Returns the petri net from a given file in apt format.
	 * <p/>
	...
	public static PetriNet getPetriNet(InputStream data, boolean suppressWarnings) throws IOException,
		...
		((AptPNFormatParser) ctx.getParser()).suppressWarnings(suppressWarnings);
