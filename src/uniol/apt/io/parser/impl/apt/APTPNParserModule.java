...
/**
 * Module for parsing a file in apt format into a pn.
 * <p/>
 * @author Manuel Gieseking
 */
public class APTPNParserModule extends AbstractModule {

	private final static String DESCRIPTION = "This module parses a Petri net or labeled Petri Net.";
	private final static String TITLE = "LPN-Parser";
	private final static String NAME = "LPN-Parser";
	...
	public void require(ModuleInputSpec inputSpec) {
		inputSpec.addParameter("inputstream", InputStream.class, "The input stream from which the net is read");
	}
	...
	public void run(ModuleInput input, ModuleOutput output) throws ModuleException {
		...
		try {
			output.setReturnValue("pn", PetriNet.class, APTPNParser.getPetriNet(data));
		} catch (IOException e) {
