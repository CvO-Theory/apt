 ...
 */
public class RandomTNetGeneratorModule extends AbstractModule {
	...
	public void require(ModuleInputSpec inputSpec) {
		...
		inputSpec.addOptionalParameter("k", Integer.class, null, "maximum number of token of a place in the"
			+ " t-net.");
	}
