 ...
 *
 */
public abstract class AbstractExtendTSModule extends AbstractModule {
	@Override
	...
	abstract void addRequire(ModuleInputSpec inputSpec);
	abstract void initExtender(ExtendTransitionSystem extender, ModuleInput input);
}
