Analysis of Petri Nets and labeled Transition systems - APT
===========================================================
...
the software, Ant is used [http://ant.apache.org]. The configuration for Ant is
...
at some of the sample files to get started!
